<?php
/**
 * Taxonomy base class, for creating custom taxonomies.
 *
 * @package eternia
 */
...
abstract class Taxonomy {
	 ...
	 * Constructor.
	 *
	 * @param string $slug Taxonomy slug or name.
	 */
	 ...
	 * @return array  $registered_object_types List of post types that were registered
	 *                      in the taxonomy.
	 */
	protected function register_wp_taxonomy( $slug, $object_types, $args ) {
		...
		$registered_object_types = array_filter(
			$register_result,
			function ( $result ) {
