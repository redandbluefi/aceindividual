...
<div class="accordion-item">
  ...
  ?>
  <button id="<?php echo esc_attr($accordion_item_id); ?>" class="accordion-item__header" aria-expanded="false"
    aria-controls="accordion-item__panel-<?php echo esc_attr($accordion_item_id); ?>">
    <span><?php echo esc_html($counter); ?>
      <?php echo esc_html($args['accordion_item']['accordion']['accordion_heading']); ?></span>
  ...
  <div class="accordion-item__section-wrapper">
    <section id="accordion-item__panel-<?php echo esc_attr($accordion_item_id); ?>"
      class="accordion-item__panel entry-content" aria-labelledby="<?php echo esc_attr($accordion_item_id); ?>">
