			...
			<div class="block-frontpage-hero__buttons">
				<?php while ( have_rows( 'frontpage-hero_buttons' ) ) : ?>
					...
					<?php if ( ( $button_url && $button_title ) && ( '_blank' === $button_target ) ) : ?>
						<a href="<?php echo esc_url( $button_url ); ?>" class="button-primary-icon" target="<?php echo esc_attr( $button_target ); ?>" rel="noreferrer noopener">
					...
					<?php elseif ( $button_url && $button_title ) : ?>
						<a href="<?php echo esc_url( $button_url ); ?>" class="button-primary" target="<?php echo esc_attr( $button_target ); ?>">
							<?php echo esc_html( $button_title ); ?>
						</a>
					<?php endif; ?>
				<?php endwhile; ?>
