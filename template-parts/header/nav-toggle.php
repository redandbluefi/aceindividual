...
$defaults = array(
	...
	'icon_open'          => 'nav-open.svg',
	'icon_close'         => 'nav-close.svg',
);
...
<div class="<?php echo esc_attr( $wrapper_classes ); ?>">
	<button aria-controls="nav"
			...
			class="<?php echo esc_attr( $args['class'] ); ?>__button"
			type="button"
			data-action="open"
	...
	<?php if ( $args['button_text'] ) : ?>
		<span class="<?php echo esc_attr( $args['class'] ); ?>__text"><?php echo esc_html( $args['button_text'] ); ?></span>
	<?php endif; ?>
	<?php
	inline_svg(
		$args['icon_open'],
